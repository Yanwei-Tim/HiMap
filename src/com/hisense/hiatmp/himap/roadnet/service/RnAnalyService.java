...
import com.hisense.hiatmp.himap.roadnet.astar.AStar;
...
public class RnAnalyService extends BaseRnService {
	 ...
	 * @param endpoint 终点
	 * @param inpoints 必经点
	 * @param outpoints 绕过点(TODO,最短路径查询暂不支持绕过点)
	 * @param querytype 查询类型 0：最短路径 1:最少耗时(TODO,目前暂不支持最短耗时)
	 * @return 路径字符串
	 */
	 ...
	 * @param distance 搜索距离
	 * @param sectionid 路段编号 (TODO 路段编号)
	 * @return 设备集合
	 */
