...
public abstract class BaseRoadline<M extends BaseRoadline<M>> extends Model<M> implements IBean {
	...
	public void setLinelength(java.math.BigDecimal linelength) {
		set("LINELENGTH", linelength);
	}

	public java.math.BigDecimal getLinelength() {
		return get("LINELENGTH");
	}
